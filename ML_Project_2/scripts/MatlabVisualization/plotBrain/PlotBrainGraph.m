...
function [myH] = PlotBrainGraph(CM,CC,CC2,CodeBook,T_conn,Factor_SphereSize,...
    ...
    if ~isempty(CA)
      ...
      [myH]=show_cm_extended(CM,CC,CC2,CodeBook,3,'gamma',pp.gamma,'FctForColSph',pp.FctForColSph,...
